...
-- Ajout de code-postale dans la table suite à un oubli
ALTER TABLE Ville
ADD COLUMN   code_postal INT UNSIGNED NOT NULL ;
...
CREATE TABLE IF NOT EXISTS Attraction (
    ...
    moyenne FLOAT,
    numTel VARCHAR (100),
    type ENUM('site touristique', 'musée','parc', 'divertissement', 'zoo','aquariums'),
    horaires TIME,
    PRIMARY KEY (id_Attraction),
    FOREIGN KEY (id_ville) REFERENCES Ville(id_ville)
);
ALTER TABLE Attraction
MODIFY horaires TINYTEXT;
...
CREATE TABLE IF NOT EXISTS Camping (
    ...
    type ENUM('Bungalow', 'Caravane', 'Camping Car', 'tente'),
    dprix REAL,
    PRIMARY KEY (id_hebergement),
    FOREIGN KEY (id_hebergement) REFERENCES Hebergement(id_hebergement)
);
...
CREATE TABLE IF NOT EXISTS Photographie (
    ...
    id_restaurant INT UNSIGNED  NULL, #null si c'est une photo d'un hebergement ou restaurant
    id_hebergement INT UNSIGNED  NULL,
    id_Attraction INT UNSIGNED  NULL,
...
INSERT INTO Departement (id_departement, nom_departement)
VALUES (54,'Meurthe-Moselle'),
        (57,'Moselle'),
        (88, 'Vosges');



INSERT INTO Ville (id_ville, nom_ville, code_postal, id_departement)
VALUES
  (1, 'Paris', 75000, 75),
...
INSERT INTO Camping (id_hebergement, periode, nbemplacements, type, dprix)
VALUES
(1, 'Avril - Septembre', 100, 'Bungalow', 50),
(2, 'Mai - Octobre', 80, 'Caravane', 40),
(3, 'Juin - Août', 120, 'Camping Car', 30),
(4, 'Mars - Novembre', 150, 'tente', 45),
(5, 'Avril - Septembre', 90, 'Bungalow', 55),
(6, 'Mai - Octobre', 110, 'Caravane', 35),
(7, 'Juin - Août', 130, 'Camping Car', 60),
(8, 'Mars - Novembre', 140, 'tente', 50),
(9, 'Avril - Septembre', 100, 'tente', 45),
(10, 'Mai - Octobre', 85, 'Camping Car', 40),
(11, 'Juin - Août', 95, 'Bungalow', 35),
(12, 'Mars - Novembre', 105, 'Caravane', 55),
(13, 'Avril - Septembre', 115, 'tente', 50),
(14, 'Mai - Octobre', 125, 'Camping Car', 45),
(15, 'Juin - Août', 135, 'tente', 40);
...
VALUES
(1, 'Le Gourmet', '123 Rue de Cuisine, Paris', 'Paris, France', 4.5, '0123456789', 'Française', 2, 1, 1, NULL),
...
(15, 'Nancy Delight', '123 City Center, Nancy', 'Nancy, France', 4.4, '1523456789', 'Moderne', 1, 15, 15, NULL);
...
CREATE USER 'internauteDHVM'@'localhost' IDENTIFIED BY 'jesuis4';
 GRANT SELECT ON Offre.* TO 'internauteDHVM'@'localhost';

 CREATE USER 'gestionnaireDHVM'@'localhost' IDENTIFIED BY 'jegere5';
 GRANT SELECT, UPDATE, INSERT, DELETE ON Offre.* TO 'gestionnaireDHVM'@'localhost';

 CREATE USER 'administrateurDHVM'@'localhost' IDENTIFIED BY 'hereisBoss2';
GRANT ALL PRIVILEGES  ON Offre.* TO 'administrateurDHVM'@'localhost';

 CREATE USER 'utilisateurDHVM'@'localhost' IDENTIFIED BY 'hello6';
 GRANT INSERT ON Offre.Internaute TO 'utilisateurDHVM'@'localhost';
 GRANT INSERT ON Offre.Avis TO 'utilisateurDHVM'@'localhost';
